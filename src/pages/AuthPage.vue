    ...
    <div class="auth-container">
      ...
      <div class="auth-card">
        ...
        <form @submit.prevent="submit" class="auth-form">
          ...
          <!-- Google OAuth Button -->
          <button type="button" class="google-button" @click="loginWithGoogle" :disabled="isGoogleLoading" :class="{ 'loading': isGoogleLoading }">
            <svg v-if="isGoogleLoading" class="loading-spinner" viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" stroke-dasharray="31.416"
                stroke-dashoffset="31.416">
                <animate attributeName="stroke-dasharray" dur="2s" values="0 31.416;15.708 15.708;0 31.416"
                  repeatCount="indefinite" />
